...
const OverviewIcon = (props: IconProps) => (
  <svg viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path d="M7 10h14M7 14h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
    ...
    >
      <div className="relative flex h-full flex-col gap-5 overflow-hidden overflow-y-auto">
        ...
        <div className="relative flex shrink-0 flex-col gap-2">
          ...
          {
            userLocalStore.statisticalPermission && (
              ...
              >
                ...
                <OverviewIcon className={
                  `${router.location.pathname.startsWith('/overview') ? 'stroke-white' : 'stroke-tertiary group-hover:stroke-white'} size-6 duration-200 ease-in-out `
                }
                />
              </Item>
            )
          ...
          >
            <IconDangKyMonHoc
              className={`${router.location.pathname.startsWith('/register-session') ? 'stroke-white' : 'stroke-tertiary group-hover:stroke-white'} size-6 duration-200 ease-in-out `}
            />
          </Item>
